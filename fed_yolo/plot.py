...
plt.plot(X, mAP[:len(mAP_s)], label="training with server epoch 2 and local epoch 1", lw=2, color='b')
plt.plot(X, mAP2[:len(mAP_s)], label="training with server epoch 2 and local epoch 10", lw=2, color='r')
...
plt.plot(X, results_1_18[:10], label="training with server epoch 2 and local epoch 1", lw=2, color='r')
plt.plot(X, results_1_19[:10], label="training with server epoch 2 and local epoch 10", lw=2, color='b')
