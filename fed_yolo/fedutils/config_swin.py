...
# _C.TRAIN.OPTIMIZER.NAME = 'adamw' # original
# Optimizer Epsilon
...
# -----------------------------------------------------------------------------
_C.FL = CN()
_C.FL.split_type = "central"
_C.FL.max_communication_rounds = 100
_C.FL.E_epoch = 1
...
def update_config(config, args):
    _update_config_from_file(
        config,
        "/home/liangqiong/Research/Deep_Learning/Pytorch/VIT/Swin-Transformer-main/configs/swin_tiny_patch4_window7_224.yaml",
    )
